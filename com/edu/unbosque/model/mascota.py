...
def createPet(id_propietario, nombre, fecha_nacimiento, id_especie, tamano, peligroso, fotografia, microchip, sexo):
    ...
    cursor.execute("INSERT INTO mascota (id_propietario, nombre, fecha_nacimiento, id_especie, tamaño, peligroso,fotografía, microchip, sexo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
